    ...
    <div className="flex min-h-[60vh] items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground transition-colors hover:bg-navy-deep"
          >
            Go home
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Assured Life Insurance | Protection for Today" },
      {
        name: "description",
        content:
          "Assured Life offers life, health, auto, family, business and travel insurance built around real people and long-term security.",
      },
      { name: "author", content: "Assured Life" },
      { property: "og:site_name", content: "Assured Life" },
